...
@NamedQueries({
    ...
    @NamedQuery(name = "DetalleCompra.findByIdArticulo", query = "SELECT d FROM DetalleCompra d WHERE d.detalleCompraPK.idArticulo = :idArticulo"),
...
public class DetalleCompra implements Serializable {
    ...
    public String toString() {
        return "rysi.articulos.articulosweb2.entidades.DetalleCompra[ detalleCompraPK=" + detalleCompraPK + " ]";
    }
