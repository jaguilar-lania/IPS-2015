                ...
                <br>
                    <div>
                        <div id="izquierda">
                            ...
                            <ul id="MenuBar1">
                                <li><input name="Agregar tesis" value="Agregar tesis" type="button" /></li>
                                <li><input name="Agregar usuarios" value="Agregar usuarios" type="button" /></li>
                                <li><input name="Administrar catalogos" value="Administrar catalogos" type="button" /></li>
                                <li><input name="SALIR" value="SALIR" type="button" /></li>
                            </ul>
