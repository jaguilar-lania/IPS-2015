...
<body>
    ...
    <div>
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#datosTesis" data-whatever="@getbootstrap">Crear Tesis</button>
            </div>
