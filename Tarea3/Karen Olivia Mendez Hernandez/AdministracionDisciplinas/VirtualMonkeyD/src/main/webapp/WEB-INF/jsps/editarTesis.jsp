                        ...
                        <div id="derecha" align="left">                
                            <h2 align="center">Editar Disciplina</h2><br>
                                ...
                                <div>
                                    ...
                                    <input name="descripcion" type="text" style="vertical-align:middle" value="${art.descripcion}" size="80" maxlength="8" required/>
                                    <br />
                                    <br />
                                    <br />
                                    <br />
                                    <input name="registrarDisciplina" type="submit" value="Guardar" />
