                ...
                <div>
                    ...
                    <form action="registrarTesis" method>
                        ...
                        <div id="derecha" align="left">                
                            <h2 align="center">Registrar Tesis</h2><br>
                                <br />

                                <div>

                                    <label>Titulo de la Tesis</label>
                                    <input name="titulo" type="text" style="vertical-align:middle" value="" size="80" maxlength="80" required/>
                                    <br />
                                    <br />
                                    <label>Nombre del autor</label>
                                    <input name="autor" type="text" style="vertical-align:middle" value="" size="80" maxlength="80" required/>
                                    <br />
                                    <br />
                                    ...
                                    <input name="director" type="text" style="vertical-align:middle" value="" size="80" maxlength="80" required/>
                                    ...
                                    <br />
                                    <input name="registrarTesis" type="submit" value="Registrar tesis" />
