...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <style> 
        ...
        #derecha { position: relative; width: 70%; top: 0; right: 0; background: #ddf; float: right; height: 900px; } 
                ...
                <br>
                    <div>
                        <div id="izquierda">
                            ...
                            <ul id="MenuBar1">
                                <li> <form action="registrarDisciplina" method>
                                            <input type='submit' name='' value='Agregar disciplina'>
                                     </form>
                            </li>
                                <li> <form action="salirDisciplina" method>
                        ...
                        <div id="derecha" align="left">
                            <h2 align="left">Busqueda de disciplina</h2>
                                ...
                                <c:forEach items="${disciplina}" var="art">
                                    <li>
                                        ...
                                        <form action="editarDisciplina" method>
                                            ...
                                            <br>
                                        <form action="eliminarDisciplina" method>
